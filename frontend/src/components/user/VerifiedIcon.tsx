...
export default function VerifiedIcon() {
  return (
    ...
    >
      <path
        transform="translate(-2.88, -2.88), scale(1.86)"
        fill="#00fad0"
      ...
      <motion.path
        ...
        transition={{ duration: 2, ease: "easeInOut", delay: 0.5 ,repeat: Infinity, repeatType: "loop"}}
      />
      ...
      <motion.path
        ...
        initial={{ pathLength: 0 }}
        animate={{ pathLength: 1 }}
        transition={{ delay: 2, duration: 0.8, ease: "easeInOut", repeat: Infinity, repeatType: "mirror" }}
      />
    </svg>
  );
}