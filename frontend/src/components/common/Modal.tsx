...
const Modal: React.FC<ModalProps> = ({ isOpen, title, message, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-[2px] flex items-center justify-center z-50 transition-opacity">
      <div className="bg-white rounded-xl shadow-lg w-96 p-6 text-center animate-fadeIn">
        <motion.svg
